...
@section('title', 'Home - Sistem Manajemen Ruangan')
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    @else
                        <a href="{{ route('login') }}" class="bg-blue-500 hover:bg-blue-600 text-white px-6 py-2 rounded-lg text-sm font-medium transition duration-200">Login</a>
                    @endauth
                </div>
            </div>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="mt-16 text-center">
            <div class="bg-white rounded-xl shadow-lg p-8">
                ...
                @auth
                    <a href="{{ route('peminjaman.create') }}" class="inline-block bg-blue-500 hover:bg-blue-600 text-white px-8 py-3 rounded-lg text-lg font-medium transition duration-200">Buat Peminjaman</a>
                @else
                    <a href="{{ route('login') }}" class="inline-block bg-blue-500 hover:bg-blue-600 text-white px-8 py-3 rounded-lg text-lg font-medium transition duration-200">Login Sekarang</a>
                @endauth
            </div>
        </div>
    </div>
