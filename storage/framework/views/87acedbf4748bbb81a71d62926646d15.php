...
<div class="bg-gray-50 min-h-screen">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-8">
                    <span class="text-gray-700">Halo, <strong><?php echo e(Auth::user()?->NAMA_USER ?? 'User'); ?></strong></span>
                    <a href="<?php echo e(route('peminjaman.index')); ?>" class="text-gray-700 hover:text-blue-600 font-medium text-sm">Peminjaman Saya</a>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <!-- Buat Peminjaman -->
            <a href="<?php echo e(route('peminjaman.create')); ?>" class="bg-blue-500 hover:bg-blue-600 transition rounded-lg shadow-md p-6 text-white">
            ...
            <!-- Lihat Peminjaman -->
            <a href="<?php echo e(route('peminjaman.index')); ?>" class="bg-white rounded-lg shadow-md hover:shadow-lg transition p-6 border-t-4 border-gray-300">
                <div class="flex items-start">
                    <div class="flex-shrink-0">
        ...
        <div class="bg-white rounded-lg shadow-md p-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                ...
                <div class="bg-blue-50 rounded-lg p-6 border-l-4 border-blue-500">
                    ...
                    <p class="text-4xl font-bold text-blue-600"><?php echo e($totalPeminjaman); ?></p>
                </div>
                ...
                <div class="bg-yellow-50 rounded-lg p-6 border-l-4 border-yellow-500">
                    ...
                    <p class="text-4xl font-bold text-yellow-600"><?php echo e($menunggu); ?></p>
                </div>

                <!-- Disetujui -->
                <div class="bg-green-50 rounded-lg p-6 border-l-4 border-green-500">
                    <p class="text-gray-600 font-medium text-sm mb-2">Disetujui</p>
                    <p class="text-4xl font-bold text-green-600"><?php echo e($disetujui); ?></p>
                </div>

                <!-- Selesai -->
                <div class="bg-gray-100 rounded-lg p-6 border-l-4 border-gray-400">
                    <p class="text-gray-600 font-medium text-sm mb-2">Selesai</p>
                    <p class="text-4xl font-bold text-gray-700"><?php echo e($selesai); ?></p>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\USER\Documents\GILAA\resources\views/dashboard.blade.php ENDPATH**/ ?>